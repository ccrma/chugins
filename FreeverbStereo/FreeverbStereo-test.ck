...
//    (the bulid process should yield a FreeverbStereo.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:FreeverbStereo.chug FreeverbStereo-test.ck`
//
...
//    `chuck --chugin:FreeverbStereo.chug FreeverbStereo-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a FreeverbStereo
FreeverbStereo obj;
