...
//    (the bulid process should yield a DjembeMIDI.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:DjembeMIDI.chug DjembeMIDI-test.ck`
//
...
//    `chuck --chugin:DjembeMIDI.chug DjembeMIDI-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a DjembeMIDI
DjembeMIDI obj;
