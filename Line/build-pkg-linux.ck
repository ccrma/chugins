...
ver.generateVersion("./", "Line_linux", "https://ccrma.stanford.edu/~nshaheed/" + path);
...
chout <= "scp Line_linux.zip nshaheed@ccrma-gate.stanford.edu:~/Library/Web/" <= path <= IO.newline();

// Generate a version definition json file, stores this in "chumpinate/<VerNo>/Line_linux.json"
ver.generateVersionDefinition("Line_linux", "./" );