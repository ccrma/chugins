...
public:
    ...
    SAMPLE tick(SAMPLE in)
    {
        ...
        // 0 is last since it's the least-likely
        if (interpolate == 1)
        {
...
private:
    ...
    {
        return (y1 + mu * ((y2 - y1) - 0.1666667f * (1. - mu) * ((y3 - y0 - 3.0f * (y2 - y1)) * mu + (y3 + 2.0f * y0 - 3.0f * y1))));
    }
