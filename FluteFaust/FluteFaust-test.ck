...
//    (the bulid process should yield a FluteFaust.chug file)
//
// 2) you can manullay load the chugin when you run this program
//    `chuck --chugin:FluteFaust.chug FluteFaust-test.ck`
//
...
//    `chuck --chugin:FluteFaust.chug FluteFaust-test.ck -v3`
//--------------------------------------------------------------------

// instantiate a FluteFaust
FluteFaust obj;
