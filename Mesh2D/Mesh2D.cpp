...
CK_DLL_MFUN(mesh2d_setParam);
CK_DLL_MFUN(mesh2d_getParam);
...
CK_DLL_QUERY( Mesh2D )
{
    ...
    QUERY->add_mfun(QUERY, mesh2d_setParam, "float", "param");
    // example of adding argument to the above method
    QUERY->add_arg(QUERY, "float", "arg");

    // example of adding getter method
    QUERY->add_mfun(QUERY, mesh2d_getParam, "float", "param");
...
CK_DLL_CTOR(mesh2d_ctor)
{
    ...
    Mesh2D * bcdata = new Mesh2D(API->vm->get_srate());
