...
// run: chuck abcPartsExtended.ck
//  demonstrates the use of P: in the header to sequence 
//  the body P:.  The pattern spec in the header include
//  DbABC extended syntax for randomized choice.
//
"X:1\n" +
"M:4/4\n" +
"L:1/4\n" +
