...
/*
 * DONE add methods
 * DONE add method glue
 * DONE add descriptions
 * TODO add test files
 * TODO add examples
 * TODO update comments in Scaler.cpp
 * TODO clipping
 */
...
CK_DLL_QUERY( Scaler )
{
    ...
    QUERY->add_arg(QUERY, "float", "center");
    QUERY->add_arg(QUERY, "float", "radius");
    QUERY->doc_func(QUERY, "set the output range by a center and a radius");
    ...
    QUERY->doc_func(QUERY, "set both the input and output ranges");
    ...
    QUERY->doc_func(QUERY, "set both the input and output ranges with a center and a radius");

    QUERY->add_mfun(QUERY, scaler_getInMin, "float", "inMin");
    QUERY->doc_func(QUERY, "get the bottom of the input range");
    QUERY->add_mfun(QUERY, scaler_getInMax, "float", "inMax");
    QUERY->doc_func(QUERY, "get the top of the input range");
    QUERY->add_mfun(QUERY, scaler_getOutMin, "float", "outMin");
    QUERY->doc_func(QUERY, "get the bottom of the output range");
    QUERY->add_mfun(QUERY, scaler_getOutMax, "float", "outMax");
    QUERY->doc_func(QUERY, "get the top of the output range");

    QUERY->add_mfun(QUERY, scaler_getInCenter, "float", "inCenter");
    QUERY->doc_func(QUERY, "get the center of the input range");
    QUERY->add_mfun(QUERY, scaler_getInRadius, "float", "inRad");
    QUERY->doc_func(QUERY, "get the radius of the input range");
    QUERY->add_mfun(QUERY, scaler_getOutCenter, "float", "outCenter");
    QUERY->doc_func(QUERY, "get the center of the output range");
    QUERY->add_mfun(QUERY, scaler_getOutRadius, "float", "outRad");
    QUERY->doc_func(QUERY, "get the radius of the output range");
