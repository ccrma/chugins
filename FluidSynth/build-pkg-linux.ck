...
// The chugin file
ver.addFile("./builddir-linux/FluidSynth.chug");
...
ver.generateVersion("./", "FluidSynth_linux", "https://ccrma.stanford.edu/~nshaheed/" + path);
...
chout <= "scp FluidSynth_linux.zip nshaheed@ccrma-gate.stanford.edu:~/Library/Web/" <= path <= IO.newline();

// Generate a version definition json file, stores this in "chumpinate/<VerNo>/Chumpinate_linux.json"
ver.generateVersionDefinition("FluidSynth_linux", "./" );